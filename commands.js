...
module.exports = [
    ...
    },
    {
        ...
        async execute(interaction, args) {
            woo = async callback => {
                await interaction.callback(callback.size > 0 ? `Deleted ${callback.size} message${callback.size > 1 ? "s" : ""}, Ghost Boss!` : "Commander, I'm pretty sure I can't delete **nothing**.");
